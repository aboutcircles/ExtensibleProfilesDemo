...
public sealed record SchemaOrgImageObject
{
    ...
    [JsonPropertyName("contentUrl")] public string ContentUrl { get; set; } = string.Empty; // ipfs://, ar://, data:
    [JsonPropertyName("url")] public string? Url { get; set; } // optional HTTP mirror
}
